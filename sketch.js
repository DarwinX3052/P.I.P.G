...
function draw() {
	...
	if(gameState === 1) {
		...
		textSize(20);
		text("W to jump A and D to move Space to sprint", -100, 900);
	...
	if(gameState === 3) {
		...
		text("Art, Music, and Programming done by DarwinX3052", 100, 200);
		text("Thank You For Playing :)", 100, 300);
		text("Press Enter to Play a More Difficult Version of The Game", 100, 700);
